...
# ⚠️ Please don't change our credits 𝚃𝙷𝙰𝙽𝙺𝚂 𝚃𝙾 & 𝙳𝙴𝚅 👇🏻
    ...
    ABOUT_TXT = """<b>✯ 𝙼𝚈 𝙽𝙰𝙼𝙴: {}
✯ ᴍʏ ʟᴏᴠᴇ: <a href=https://t.me/jk1boss>ᴍʏ ᴏᴡɴᴇʀ🥰</a>
✯ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ: <a href=https://t.me/Lusifilms>Click Hare</a>
✯ ᴍʏ ᴏᴡɴᴇʀ: <a href=https://t.me/jk1boss>Jk Developer</a>
✯ ʟɪʙʀᴀʀʏ: ɴᴏ ɪᴅᴇᴀ
✯ ʟᴀɴɢᴜᴀɢᴇ: ʜɪɴᴅɪ 🇮🇳
✯ ᴅᴀᴛᴀʙᴀsᴇ: ꜰʀᴇᴇ ᴠᴀʟᴀ 🤫
✯ sᴇʀᴠᴇʀ: ꜰʀᴇᴇ ᴠᴀʟᴀ 🤫
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    I_CUD_NT = """Hello {} मुझे इस नाम की कोई मूवी नही मिली 
    मुझे लगता है आपकी Spelling गलत है, कृपया Spelling की जांच करे"""
    
    CUDNT_FND = """Hello {} मुझे इस नाम की कोई मूवी नही मिली 

क्या आपका मूवी इनमें से कोई है 👇👇"""
