...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5554564210 1991522624').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001946764456').split()]
...
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/fileraj")
MSG_ALRT = environ.get('MSG_ALRT', 'Cheaking')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', 0))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001433302422))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Lusifilms')
